...
export default defineConfig({
    ...
    output: {
        copy: [
            ...
            { from: path.join(__dirname, 'profithubtool.co.ke/public/Official Bots'), to: 'Official Bots' },
            { from: path.join(__dirname, 'profithubtool.co.ke/public/Hybrid Bots'), to: 'Hybrid Bots' },
            { from: path.join(__dirname, 'profithubtool.co.ke/public/Normal Bots'), to: 'Normal Bots' },
            {
                from: path.join(__dirname, 'profithubtool.co.ke/public/Automatic'),
                to: 'Automatic',
                globOptions: {
                    ignore: ['**/AUTOTRADER.xml'],
                },
            },
