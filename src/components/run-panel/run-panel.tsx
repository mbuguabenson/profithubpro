...
const RunPanel = observer(() => {
    ...
    const show_run_panel = true; // Always show run panel on all tabs
    if (active_tour === 'bot_builder' || active_tab === DBOT_TABS.DASHBOARD || active_tab === DBOT_TABS.DTRADER) return null;
