...
const WorkspaceGroup = observer(({ onOpenScanner }: { onOpenScanner?: () => void }) => {
    ...
    return (
        <div className='toolbar__wrapper'>
            <div className='toolbar__group toolbar__group-btn' data-testid='dt_toolbar_group_btn'>
                ...
                <div className='vertical-divider' />
                <ToolbarIcon
                    popover_message={localize('AI Scanner')}
                    icon={
                        <span
                            className='toolbar__icon'
                            id='db-toolbar__ai-scanner-button'
                            onClick={onOpenScanner}
                            style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}
                        >
                            <span style={{ fontSize: '10px', background: 'var(--brand-red-coral, #ff444f)', color: 'white', padding: '2px 4px', borderRadius: '3px', fontWeight: 'bold', lineHeight: 1 }}>AI</span>
                        </span>
                    }
                />
                <div className='vertical-divider' />
