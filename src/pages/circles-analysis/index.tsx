...
import ProDigitCracker from '../digit-cracker';
import './circles-analysis.scss';

const ProCirclesAnalysis = observer(() => {
    const { analysis, common, smart_auto } = useStore();
    const [active_module, setActiveModule] = useState<'circles' | 'digit_cracker'>('circles');
    ...
    return (
        <div className='pro-analysis-combo'>
            <div className='pro-analysis-combo__switcher'>
                <button
                    className={classNames({ active: active_module === 'circles' })}
                    onClick={() => setActiveModule('circles')}
                >
                    Pro Circles Analysis
                </button>
                <button
                    className={classNames({ active: active_module === 'digit_cracker' })}
                    onClick={() => setActiveModule('digit_cracker')}
                >
                    Pro Digit Cracker
                </button>
            </div>

            {active_module === 'digit_cracker' ? (
                <ProDigitCracker />
            ) : (
...
export default ProCirclesAnalysis;
