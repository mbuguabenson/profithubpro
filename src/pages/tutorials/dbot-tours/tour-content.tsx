...
export const DBOT_ONBOARDING = [
    {
        ...
        content: (
            <TourSteps
                ...
                media={getUrlBase('assets/videos/dbot-onboarding-tour-step-1.mp4')}
                step_index={1}
            />
        ),
        ...joyride_props,
    ...
    },
    {
        ...
        content: (
            <TourSteps
                ...
                media={getUrlBase('assets/videos/dbot-onboarding-tour-step-2.mp4')}
                step_index={2}
            />
        ),
        ...joyride_props,
    ...
    },
    {
        ...
        content: (
            <TourSteps
                ...
                media={getUrlBase('assets/videos/dbot-onboarding-tour-step-3.mp4')}
                step_index={3}
            />
        ),
        ...joyride_props,
    ...
    },
    {
        ...
        content: (
            <TourSteps
                ...
                media={getUrlBase('assets/videos/dbot-onboarding-tour-step-5.mp4')}
                step_index={5}
            />
        ),
    ...
    },
    {
        ...
        content: (
            <TourSteps
                ...
                media={getUrlBase('assets/videos/dbot-onboarding-tour-step-6.mp4')}
                step_index={6}
            />
        ),
        ...joyride_props,
    ...
    <div className='joyride-content'>
        ...
        <div>
            <video autoPlay loop controls playsInline preload='auto' disablePictureInPicture controlsList='nodownload'>
                <source src={getUrlBase('assets/videos/bot-builder-tour-step-4.mp4')} type='video/mp4' />
            </video>
        </div>
    </div>
);
...
const Step5 = ({ show_label = false }) => (
    <div className='joyride-content'>
        ...
        <div>
            <video autoPlay loop controls playsInline preload='auto' disablePictureInPicture controlsList='nodownload'>
                <source src={getUrlBase('assets/videos/bot-builder-tour-step-5.mp4')} type='video/mp4' />
            </video>
        </div>
    </div>
);
...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    ...
    },
    {
        ...
        media: getUrlBase('assets/videos/dbot-mobile-onboarding-step-1.mp4'),
        tour_step_key: 2,
    },
    {
        ...
        media: getUrlBase('assets/videos/dbot-mobile-onboarding-step-2.mp4'),
        tour_step_key: 3,
    },
    {
        ...
        media: getUrlBase('assets/videos/dbot-mobile-onboarding-step-3.mp4'),
        tour_step_key: 4,
    },
    {
    ...
    },
    {
        ...
        media: getUrlBase('assets/videos/dbot-mobile-onboarding-step-5.mp4'),
        content: [
    ...
    },
    {
        ...
        media: getUrlBase('assets/videos/dbot-mobile-onboarding-step-6.mp4'),
        content: [
